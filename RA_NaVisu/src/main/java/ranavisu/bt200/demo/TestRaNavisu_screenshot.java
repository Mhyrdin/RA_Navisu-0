...
public class TestRaNavisu_screenshot extends Activity implements OnARGeoInitializedListener, OnLocationChangedListener, OnLocationResolvedListener,
        OnARGeoRenderCycleListener, OnObjectPickedListener, TextureView.SurfaceTextureListener, I_LocationSet {
    ...
    private double[][] tabAlatLong = {
           ...
           /* {1.5,  48.418246, -4.472069},
            {1.5,  48.418368, -4.472092},
            {1.5,  48.418328, -4.472670},
            {1.5,  48.418197, -4.472645},*/
             };
    //----------------------------------------------------------------------------------------------
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayControl = new DisplayControl(TestRaNavisu_screenshot.this);

        setContentView(R.layout.test1_ranavisu_screenshot);
        ...
        FrameLayout frameLayout3D = (FrameLayout) getLayoutInflater().inflate(R.layout.test1_ranavisu_screenshot, mARGeoMoverioFragment.getRootView(), false);
        frameLayout3D.setAlpha(0.5f);
        ...
        GPS_on = true;
        my_gps = new GPSTracker(TestRaNavisu_screenshot.this);
        ...
        buttonSetCoordinates.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!GPS_on) {
                    ...
                    PopupMenu popup = new PopupMenu(TestRaNavisu_screenshot.this, buttonSetCoordinates);
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            Toast.makeText(TestRaNavisu_screenshot.this, "You selected: " + lat + " " + lon, Toast.LENGTH_SHORT).show();
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        Logger.getAnonymousLogger().log(Level.WARNING, "Sizes =  " + size.first + " , " + size.second);
        parameters.setPreviewSize(size.first, size.second);
        parameters.setPreviewSize(640, 480);

        orgPreviewWidth = 640;//size.first;
        orgPreviewHeight = 480;//size.second;
        ...
        mTextureView.setAlpha(0.45f);
        //updateTextureViewSize(1120, 840);
    ...
    private void updateTextureViewSize(int viewWidth, int viewHeight) {
        ...
        int mVideoWidth = orgPreviewWidth;
        int mVideoHeight = orgPreviewHeight;
        ...
        int pivotPointX = viewWidth / 2 - 150;
    ...
    public void onARGeoInitialized(final ARGeoFragment arRGeoFragment) {
        ...
        //arRGeoFragment.getRootView().setBackground(mTextureView.getBackground());
        ...
        for (String strL : tabL){ // loop to add all sample locations
            ...
            if (strL.equals(TestRaNavisu_screenshot.this.getString(R.string.pointO)) || strL.equals(TestRaNavisu_screenshot.this.getString(R.string.coursTennis))
                    || strL.equals(TestRaNavisu_screenshot.this.getString(R.string.terrainBasket))  || strL.equals(TestRaNavisu_screenshot.this.getString(R.string.pointP))
                    || strL.equals(TestRaNavisu_screenshot.this.getString(R.string.pointC) ) || strL.equals(TestRaNavisu_screenshot.this.getString(R.string.pointK1)) || strL.equals(TestRaNavisu_screenshot.this.getString(R.string.pointK2))) {
                ((ImageView) exampleARViewEnsta.findViewById(R.id.poi_image_imageview)).setImageResource(R.drawable.logo_ranavisu);
            }else if (strL.equals(TestRaNavisu_screenshot.this.getString(R.string.place_d_armes))){
            ...
            exampleARWidgetEnsta.setBaseDepth(50);
            exampleARWidgetEnsta.setBaseDepth(50);
            if (strL.substring(0, 3).equals("cor")){
                exampleARWidgetEnsta.setBaseDepth(70);
            }
        ...
        arRGeoFragment.setMaxScalingDistance(320);
    ...
    public void onLocationResolved(final Location location) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(TestRaNavisu_screenshot.this, "Location resolved: " + latitude + " " + longitude, Toast.LENGTH_SHORT).show();
        ...
        mARGeoMoverioFragment.addRenderCycleRunnable(new Runnable() {
            ...
            public void run() {
               ...
               // arWidget.setBaseDepth(28);
                ...
                double averageLat = 0, averageLon = 0;
                ...
                for (int i=0;i<nbPts-1; i++){
                        ...
                        Vector3 nextPt = new Vector3(-(locaDest.getLatitude()-latit)*ARGeoData.METERS_IN_ONE_EARTH_DEGREE_APPROXIMATION,(locaDest.getLongitude()-longit)*ARGeoData.METERS_IN_ONE_EARTH_DEGREE_APPROXIMATION,0);
                        points.add(nextPt);
                        already.add(idxRnd);
                        averageLat +=locaDest.getLatitude();
                        averageLon +=locaDest.getLongitude();
                }
               ...
               /* Route rPath = new Route(waypoints, arEntity);
                ...
                ExampleLocationAbsolute averageLocation = new ExampleLocationAbsolute();
                averageLocation.setK(averageLat/(double) nbPts);
                averageLocation.setA(averageLon/(double) nbPts);
                averageLocation.setAltitude(0);
...
/*
    ...
    public void onObjectPicked(Object3D object) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(TestRaNavisu_screenshot.this, "Native object picker click", Toast.LENGTH_SHORT).show();
